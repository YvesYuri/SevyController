...
import 'package:controller/src/modules/devices_rooms/widgets/device_widget.dart';
...
class _DevicesRoomsViewState extends State<DevicesRoomsView> {
  ...
  void showDevicePopUp(DeviceModel? device) {
    showDialog(
      context: context,
      builder: (context) {
        return DeviceWidget(
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      devicesRoomsController.getConnectivity();
      devicesRoomsController.changeCurrentBuilding(widget.building!);
      devicesRoomsController.subscribeDeviceSearchProvisioner();
    });
  }
      ...
      return Column(
        children: [
          AnimatedSwitcher(
            ...
            child: devicesRoomsController.hasInternetConnection
                ? Container()
                : Container(
                    height: 40,
                    ...
                    primaryItems: devicesRoomsController.reorderRooms
                        ...
                        : [
                            CommandBarButton(
                              ...
                              onPressed:
                                  devicesRoomsController.hasInternetConnection
                                      ? () async {
                                        devicesRoomsController.getWifiInfo();
                                        showDevicePopUp(null);
                                      }
                                      : null,
                            ),
                            CommandBarButton(
                              ...
                              onPressed: devicesRoomsController.hasInternetConnection
                                      ? () {
                                showRoomPopUp(null);
                              } : null,
                            ),
                ...
                content: AnimatedSwitcher(
                  ...
                  child: devicesRoomsController.reorderRooms
                          ...
                          child: ReorderableListView(
                            ...
                            onReorder: (oldIndex, newIndex) {
                              setState(() {
                                ...
                                var room = devicesRoomsController
                                    .roomsByBuilding
                                    .removeAt(oldIndex);
                            ...
                            children: [
                              for (var room
                                  in devicesRoomsController.roomsByBuilding)
                                Container(
                      ...
                      : LiveList.options(
                          padding: const EdgeInsets.all(24),
                          itemCount:
                              devicesRoomsController.roomsByBuilding.length,
                          ...
                          itemBuilder: (context, index, animation) {
                            var room =
                                devicesRoomsController.roomsByBuilding[index];
                            return FadeTransition(
